...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var allpets: List<com.omni.entities.PetEntity>
...
//
//                petsViewModel.delete(viewHolder!!.itemView.tag as com.omni.entities.PetEntity)
//            }
//
//        }
//
//        ItemTouchHelper(simpleItemTouchHelper).attachToRecyclerView(pets_list!!)
    ...
    private fun insertDummyData() {
        val pet = com.omni.entities.PetEntity(name = "dolcy", breed = "dog", weight = 44.0)
    ...
    private fun setUpRecyclerView() {
        ...
        petsViewModel.allpets.observe(this, Observer<List<com.omni.entities.PetEntity>> { t ->
